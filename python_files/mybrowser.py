...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        logo = QLabel()
        logo.setPixmap(QPixmap(os.path.join('images', 'Myabell_logo128.png')))
        layout.addWidget(logo)

        layout.addWidget(QLabel("Version 1.0.1"))
        layout.addWidget(QLabel("Copyright 2020 baponkar"))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action.setStatusTip("Find out more about My Browser")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_mozarella_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')), "MooseAche Homepage", self)
        navigate_mozarella_action.setStatusTip("Go to My Browser Homepage")
        navigate_mozarella_action.triggered.connect(self.navigate_mozarella)
        help_menu.addAction(navigate_mozarella_action)

        self.show()

        self.setWindowIcon(QIcon(os.path.join('images', 'Myabell_logo64.png')))
...
app.setOrganizationName("My Browser")
app.setOrganizationDomain("Myabell.com")
