...
class calculate():
    ...
    def __init__(self):
        ...
        self.resultwindow.config(font=("Arial", 35))
        ...
        self.buttonmultiply.config(font=("Arial", 25))
        ...
        self.buttoncancel.config(font=("Arial", 25))
        ...
        self.buttondeleteall.config(font=("Arial", 25))
        ...
        self.buttonresult.config(font=("Arial", 25))
